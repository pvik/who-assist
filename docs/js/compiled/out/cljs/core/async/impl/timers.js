...
var i_24924 = (0);
while(true){
if((i_24924 < arr.length)){
(arr[i_24924] = null);

var G__24925 = (i_24924 + (1));
i_24924 = G__24925;
continue;
} else {
}
...
var i_24934 = (self__.level + (1));
while(true){
if((i_24934 <= (new_level + (1)))){
(update[i_24934] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_24936 = (update[i]).forward;
(x__$2.forward[i] = (links_24936[i]));
...
var i_24938 = (0);
while(true){
if((i_24938 <= self__.level)){
var links_24939 = (update[i_24938]).forward;
if((x__$1 === (((i_24938 < links_24939.length))?(links_24939[i_24938]):null))){
(links_24939[i_24938] = (x__$1.forward[i_24938]));

var G__24940 = (i_24938 + (1));
i_24938 = G__24940;
continue;
} else {
var G__24941 = (i_24938 + (1));
i_24938 = G__24941;
continue;
}
} else {
...
var G__24943 = nx;
var G__24944 = (level__$1 - (1));
x = G__24943;
level__$1 = G__24944;
continue;
} else {
var G__24945 = x;
var G__24946 = (level__$1 - (1));
x = G__24945;
level__$1 = G__24946;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__24948 = nx;
var G__24949 = (level__$1 - (1));
x = G__24948;
level__$1 = G__24949;
continue;
} else {
var G__24950 = x;
var G__24951 = (level__$1 - (1));
x = G__24950;
level__$1 = G__24951;
continue;
}
...
//# sourceMappingURL=timers.js.map?rel=1588466957027
