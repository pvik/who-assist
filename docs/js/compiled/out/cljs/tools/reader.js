...
var G__27075 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27075;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__27076 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27076,ch);
...
if(("\\" === ch__$1)){
var ch_27077__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_27077__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_27077__$2);
} else {
}

var G__27078 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__27078;
continue;
}
}
...
var vec__27086 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27086,(0),null);
var start_column = cljs.core.nth.call(null,vec__27086,(1),null);
...
var G__27089 = cljs.core.conj_BANG_.call(null,a,form);
a = G__27089;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__27090 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__27091 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__27091);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__27090);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__27092 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27092,(0),null);
var start_column = cljs.core.nth.call(null,vec__27092,(1),null);
...
var vec__27095 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27095,(0),null);
var end_column = cljs.core.nth.call(null,vec__27095,(1),null);
...
var vec__27098 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27098,(0),null);
var start_column = cljs.core.nth.call(null,vec__27098,(1),null);
...
var vec__27101 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27101,(0),null);
var end_column = cljs.core.nth.call(null,vec__27101,(1),null);
...
var vec__27104 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27104,(0),null);
var start_column = cljs.core.nth.call(null,vec__27104,(1),null);
...
var vec__27107 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27107,(0),null);
var end_column = cljs.core.nth.call(null,vec__27107,(1),null);
...
var sb = (function (){var G__27110 = (new goog.string.StringBuffer());
G__27110.append(initch);
...
var G__27112 = (function (){var G__27111 = sb;
G__27111.append(ch);

return G__27111;
})();
var G__27113 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27112;
ch = G__27113;
continue;
}
...
switch (G__27116) {
case "\\":
var G__27120 = (function (){var G__27117 = sb;
G__27117.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__27117;
})();
var G__27121 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27120;
ch = G__27121;
continue;
...
break;
default:
var G__27122 = (function (){var G__27118 = sb;
G__27118.append(ch);

return G__27118;
})();
var G__27123 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27122;
ch = G__27123;
continue;
...
var vec__27124 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27124,(0),null);
var end_column = cljs.core.nth.call(null,vec__27124,(1),null);
...
var vec__27127 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27127,(0),null);
var column = cljs.core.nth.call(null,vec__27127,(1),null);
...
var vec__27132 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27132,(0),null);
var column = cljs.core.nth.call(null,vec__27132,(1),null);
...
var vec__27137 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27137,(0),null);
var column = cljs.core.nth.call(null,vec__27137,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__27142 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27142,(0),null);
var start_column = cljs.core.nth.call(null,vec__27142,(1),null);
...
var vec__27145 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27145,(0),null);
var end_column = cljs.core.nth.call(null,vec__27145,(1),null);
...
var G__27148 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27148,true,null,opts,pending_forms);
...
var G__27149 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27149)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27149)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27149)){
...
var _STAR_suppress_read_STAR__orig_val__27150 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__27151 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__27151);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__27150);
}});
...
var G__27152 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27152,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27152,rdr,first_line);
...
var G__27156 = matched;
var G__27157 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27156;
finished = G__27157;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__27158 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__27159 = (function (){var or__4185__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__27159);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__27158);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__27160 = cljs.tools.reader.arg_env;
var arg_env_temp_val__27161 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__27161);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27162 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27162,"(");
...
var G__27163 = (i + (1));
var G__27164 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4185__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__27160);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27165 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27165);
...
var G__27166 = cljs.core.next.call(null,s__$1);
var G__27167 = ret;
s__$1 = G__27166;
r = G__27167;
continue;
...
var G__27168 = cljs.core.next.call(null,s);
var G__27169 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27168;
key_vals = G__27169;
continue;
} else {
...
var gensym_env_orig_val__27174 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__27175 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__27175);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__27174);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27176 = token;
var G__27176__$1 = (((G__27176 == null))?null:cljs.core.subs.call(null,G__27176,(1)));
var G__27176__$2 = (((G__27176__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27176__$1));
var G__27176__$3 = (((G__27176__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27176__$2));
var G__27176__$4 = (((G__27176__$3 == null))?null:cljs.core.symbol.call(null,G__27176__$3));
if((G__27176__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27176__$4);
}
})():(function (){var G__27177 = token;
var G__27177__$1 = (((G__27177 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27177));
if((G__27177__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27177__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27188,reader){
...
var eof = cljs.core.get.call(null,map__27189__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1588466958320
