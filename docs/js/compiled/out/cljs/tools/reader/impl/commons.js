...
var G__27044 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27044;
continue;
} else {
return ch;
...
var vec__27045 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__27045,(0),null);
return (match === s);
});
...
var len__4789__auto___27050 = arguments.length;
var i__4790__auto___27051 = (0);
while(true){
if((i__4790__auto___27051 < len__4789__auto___27050)){
args__4795__auto__.push((arguments[i__4790__auto___27051]));

var G__27052 = (i__4790__auto___27051 + (1));
i__4790__auto___27051 = G__27052;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27048){
var G__27049 = cljs.core.first.call(null,seq27048);
var seq27048__$1 = cljs.core.next.call(null,seq27048);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27049,seq27048__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__27053__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__27053 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27054__i = 0, G__27054__a = new Array(arguments.length -  1);
while (G__27054__i < G__27054__a.length) {G__27054__a[G__27054__i] = arguments[G__27054__i + 1]; ++G__27054__i;}
  _ = new cljs.core.IndexedSeq(G__27054__a,0,null);
} 
return G__27053__delegate.call(this,rdr,_);};
G__27053.cljs$lang$maxFixedArity = 1;
G__27053.cljs$lang$applyTo = (function (arglist__27055){
var rdr = cljs.core.first(arglist__27055);
var _ = cljs.core.rest(arglist__27055);
return G__27053__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1588466958104
