...
return (new CustomEvent(event_name,(function (){var obj28674 = ({"detail":data});
return obj28674;
})()));
} else {
...
var f = (function (){var pred__28681 = cljs.core._EQ_;
var expr__28682 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28681.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28682))){
return (function (p1__28675_SHARP_){
return console.warn(p1__28675_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28681.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28682))){
return (function (p1__28676_SHARP_){
return console.debug(p1__28676_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28681.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28682))){
return (function (p1__28677_SHARP_){
return console.error(p1__28677_SHARP_);
});
} else {
return (function (p1__28678_SHARP_){
return console.log(p1__28678_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28685){
...
var eval_fn = cljs.core.get.call(null,map__28686__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__28688_SHARP_){
return new_def.callback(p1__28688_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__28689){
var vec__28690 = p__28689;
var ky = cljs.core.nth.call(null,vec__28690,(0),null);
var v = cljs.core.nth.call(null,vec__28690,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1588466960423
